...
export default function TaskList(props) {
    ...
    // props
    const { tasks, onTaskDelete, onTaskDone, onTaskEdit } = props
        ...
        return tasks.map(task => {
            return (
                <li className="task-item" key={task.id}>
                    ...
                    <div className="icons">
                        <div onClick={() => handleTaskDone(task.id)} className={`icon check-icon ${task.done ? 'active' : ''}`}>
                        ...
                        <div onClick={() => handleTaskEdit(task)} className="icon edit-icon">
                        ...
                        <div onClick={() => handleTaskDelete(task.id)} className="icon trash-icon">
